    ...
    override fun onStart() {
        ...
        broadcastReceiver = object : BroadcastReceiver() {
            override fun onReceive(context: Context, intent: Intent) {
                if (intent.action == FoodKotlinFirebaseMessagingService.MPESA_ORDER_PAID_ACTION) {
                    val orderId = intent.getStringExtra(FoodKotlinFirebaseMessagingService.ORDER_ID)
        ...
        broadcastManager.registerReceiver(
            broadcastReceiver,
            IntentFilter(FoodKotlinFirebaseMessagingService.MPESA_ORDER_PAID_ACTION)
        )
    }
