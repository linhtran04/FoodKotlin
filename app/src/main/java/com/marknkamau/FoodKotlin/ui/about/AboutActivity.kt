...
class AboutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvSourceCodeAbout.setOnClickListener { openUrl("https://github.com/MarkNjunge/FoodKotlin-Android") }
        ...
        tvPrivacyPolicyAbout.setOnClickListener { openUrl("https://FoodKotlin.store/privacy") }
